 ...
 */var B;((B=window.HTMLSlotElement)===null||B===void 0?void 0:B.prototype.assignedElements)!=null;const Tt="/assets/lit-c8dae599.svg",kt="/vite.svg";var Mt=Object.defineProperty,Rt=Object.getOwnPropertyDescriptor,Z=(o,t,e,i)=>{for(var s=i>1?void 0:i?Rt(t,e):t,n=o.length-1,r;n>=0;n--)(r=o[n])&&(s=(i?r(t,e,s):r(s))||s);return i&&s&&Mt(t,e,s),s};let P=class extends S{constructor(){super(...arguments),this.docsHint="Click on the Vite and Lit logos to learn more",this.count=0}render(){return At`
  ...
  `;Z([ut()],P.prototype,"docsHint",2);Z([ut({type:Number})],P.prototype,"count",2);P=Z([Ot("my-element")],P);
